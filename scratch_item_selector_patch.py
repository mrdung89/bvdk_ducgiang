...
with open(r'C:\Users\Admin\Desktop\bvdkdg\bvdk_ducgiang\utils\item_selector_dialog.py', 'r', encoding='utf-8') as f:
    c = f.read()
...
with open(r'C:\Users\Admin\Desktop\bvdkdg\bvdk_ducgiang\utils\item_selector_dialog.py', 'w', encoding='utf-8') as f:
    f.write(c)
